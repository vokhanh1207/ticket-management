...
let TicketsRepository = exports.TicketsRepository = class TicketsRepository extends typeorm_1.Repository {
    constructor(dataSource) {
        super(ticket_entity_1.Ticket, dataSource.createEntityManager());
