...
let EventsRepository = exports.EventsRepository = class EventsRepository extends typeorm_1.Repository {
    constructor(dataSource) {
        super(mail_schedule_entity_1.Event, dataSource.createEntityManager());
